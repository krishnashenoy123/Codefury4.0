				...
				<div className="logo">
					<h1>
						<Link to="/">
							<img
								style={{ width: "15%" }}
								src="https://lh3.googleusercontent.com/whWdCHvpK52qWkxadxxRiATHijar8KkJZCHtmwa3KeLyzf1hT3jqIGKE5FTJvvrmWWxneg1CGQ7VuQ624HKy=s72-rwa"
								alt="SVG"
							/>{" "}
							Study with <span className="HalfLogo"> ME</span>
						</Link>
					</h1>
				</div>
				<ul>
