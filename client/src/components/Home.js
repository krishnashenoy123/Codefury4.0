		...
		<div className="homeBody">
			<div className="midSection">
				...
				<div className="Addvertisement">
					...
					<a
						style={{ color: "blue", fontSize: "larger", fontWeight: "bolder" }}
						href="https://github.com/LogiCare-Tech/FilterForces-Extension"
						target="_blank"
						rel="noreferrer"
					>
						Click here
			...
			<div className="footer">
				<div className="leftFooter">
					...
					<h5>
						...
						<a
							href="https://www.linkedin.com/in/shreenanda-p-127242147/"
							target="_blank"
							rel="noreferrer"
						>
							Linked in{" "}
					...
					<h5>
						...
						<a
							href="https://github.com/shreenanda-8"
							target="_blank"
							rel="noreferrer"
						>
							Github
				...
				<div className="rightFooter">
					...
					<h5>
						<a
							href="https://codeforces.com/blog/entry/95234"
							target="_blank"
							rel="noreferrer"
						>
							Codeforces Blog{" "}
					...
					<h5>
						<i className="github icon" />{" "}
						<a
							href="https://github.com/LogiCare-Tech/FilterForces"
							target="_blank"
							rel="noreferrer"
						>
							Github
