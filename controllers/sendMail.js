...
const sendEmail = (to, url,txt) => {
      ...
      const mailOptions = {
          ...
          to: to,
          subject: 'Study With Me',
          html: `
          <div style="max-width: 700px; margin:auto; border: 10px solid #ddd; padding: 50px 20px; font-size: 110%;">
          <h2 style="text-align: center; text-transform: uppercase;color: teal;">Welcome to Study With Me.</h2>
          <p>Congratulations! You're almost set to start using Study With Me✮Web Application.
